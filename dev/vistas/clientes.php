                    ...
                    <form name="formulario" id="formulario" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-5 col-sm-8 col-xs-12">
                                ...
                                <input type="text" name="ingresos" id="ingresos" class="form-control" placeholder="Ingresos" required >
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-5 col-sm-8 col-xs-12">
                                <label>Egresos</label>
                                <input type="text" name="egresos" id="egresos" class="form-control" placeholder="Egresos" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-5 col-sm-8 col-xs-12">
                        ...
                        <div class="row" id="filesClient" style="display:none">
