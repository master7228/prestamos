...
<body class="theme-navyBlue  pace-done">
    ...
    <header class="navbar" id="header-navbar">
      ...
      <div class="container">
        ...
        <div class="clearfix">
          ...
          <h1 class="namelogo" style="color:#1ABC9C;font-weight: bold;width: 220px;font-size: 3em;padding-left: 0px;text-align: center;margin: 0px;">SISAP</h1>
          </div>
