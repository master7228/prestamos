...
<script>
    ...
    function descargarComprobante(idPlanPagos){
        window.location.href = "../ajax/planpagos.php?op=comprobantePago&id="+idPlanPagos; 
    }
        ...
        $.post("../ajax/prestamos.php?op=mostrarPlanPagosParaPago", {
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                if (data[index]['estado'] == 1) {
                    ...
                    linkPago = data[index]['fecha_pago']+' <a href="#" onclick="descargarComprobante('+data[index]['id']+')">Comprobante</a>';
