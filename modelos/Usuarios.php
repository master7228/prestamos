...
Class Usuarios
{
	...
	public function insertar($nombre,$direccion,$telefono,$login,$clave,$idzona,$admin,$permisos)
	{
		$sql="INSERT INTO usuarios (nombre,direccion,telefono,login,clave,idzona,estado,is_admin)
		VALUES ('$nombre','$direccion','$telefono','$login','$clave','$idzona','1','$admin')";
	...
	public function editar($idusuario,$nombre,$direccion,$telefono,$login,$clave,$idzona,$admin,$permisos)
	{
    ...
    {
    	$sql="SELECT idusuario,nombre,direccion,telefono,idzona,login,is_admin FROM usuarios WHERE login='$login' AND clave='$clave' AND estado='1'"; 
    	return ejecutarConsulta($sql);  
    }
