...
switch ($_GET["op"]){
	...
	case 'guardaryeditar':
		if (empty($idcliente)){
			...
			$rspta=$cliente->insertar($cedula,$nombre,$direccion,$telefono, $ingresos, $egresos, $id_ciudad);
			...
			$rspta=$cliente->editar($idcliente,$cedula,$nombre,$direccion,$telefono, $ingresos, $egresos, $id_ciudad);
